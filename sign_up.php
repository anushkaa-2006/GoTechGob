...
<head>
    ...
    <style>
        ...
        input[type="email"]:focus,[type="password"]:focus,[type="text"]:focus{
...
session_start();
$insert=false;
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['email'], $_POST['password'], $_POST['first_name'], $_POST['last_name'])){
$server='localhost';
$username='root';
$password='';
$dbname = 'project_data';
...
$sql=  "INSERT INTO `sign_up`(`email`, `password`, `first_name`, `last_name`,`date`) VALUES ( '$email', '$password', '$first_name','$last_name',current_timestamp());";
...
?>
    <form action="sign_up.php" method="post" id="myForm">
        <!-- <h1 class="in-up-heading">Sign Up</h1> -->
        ...
        <input type="password" id="mypass" name="password" class="password" placeholder="password" required>
        <div class="pass">         
        ...
        <input type="submit" value="Sign Up" class="in-up-btn"><br>
    </div>
    </form>
